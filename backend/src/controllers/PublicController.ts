...
export class PublicController {
	...
	@ApiOperation({
		...
		description:
			"Retorna cores e contagens de produtos para popular o componente de filtro.",
	})
	...
	@ApiOperation({
		...
		description:
			"Retorna uma lista de até 10 produtos que possuem descontos ativos.",
	})
	@ApiResponse({
		status: 200,
	...
	@ApiOperation({
		...
		description:
			"Retorna a lista de categorias para exibir as capas no catálogo.",
	})
