...
export class PublicService {
  ...
  public async searchProducts(query: string): Promise<any[]> {
    try {
      ...
      this.logger.error(`Erro ao realizar busca de produtos para a query "${query}": ${error}`);
      throw new InternalServerErrorException("Erro ao realizar a busca de produtos.");
    }
  }
  ...
  public async getProductsByCategory(
    ...
    try {
      ...
      this.logger.error(`Erro ao buscar produtos da categoria ${categoryType}: ${error}`);
      throw new InternalServerErrorException("Erro ao processar a listagem de produtos.");
    }
  }
  ...
  public async getCategoryFilters(categoryType: string) {
    try {
      ...
      this.logger.error(`Erro ao buscar filtros da categoria ${categoryType}: ${error}`);
  ...
  public async getLowStockProducts() {
    try {
      ...
      throw new InternalServerErrorException("Erro ao buscar produtos com baixo estoque.");
    }
  }
  ...
  public async getPromotions() {
    try {
      ...
      throw new InternalServerErrorException("Erro ao buscar produtos em promoção.");
    }
  }
  ...
  public async getCategoryById(categoryId: string): Promise<any> {
    try {
      ...
      this.logger.error(`Erro ao obter a categoria com ID ${categoryId}: ${error}`);
      throw new InternalServerErrorException(`Erro ao obter a categoria com ID ${categoryId}`);
    }
  }
